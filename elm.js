...
var _user$project$Toast_Types$Toast = F4(
	function (a, b, c, d) {
		return {title: a, body: b, url: c, style: d};
	});
var _user$project$Toast_Types$Model = function (a) {
	return {toasts: a};
};
...
var _user$project$Toast_Model$init = {
	ctor: '_Tuple2',
	_0: _user$project$Toast_Types$Model(
		{ctor: '[]'}),
...
var _user$project$Toast_View$viewToasts = function (toasts) {
	return A2(_elm_lang$core$List$map, _user$project$Toast_View$viewToast, toasts);
};
